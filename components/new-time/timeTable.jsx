"use client";
import "./time.css";
import ToolTip from "../subComp/tooltip";
          ...
          {[...Array(7)].map((_, index) => {
            ...
            return (
              ...
              > 
                ...
                <th   className={`${
                    who[next7Days[index]].closedDayMod == true ? "test" : ""
                  }`}>
                ...
                <td id={dayData.closedDayMod? 'info':''}
                  className={dayData.closedDayMod? '!bg-transparent':'hidden'}
                >
                  <ToolTip
                    isVisable={dayData.closedDayMod? 1:0}
                    text={dayData.closedDayModTimeString}
                    size={20}
                    className={dayData.closedDayMod ?'!bg-transparent':'invisible' }/>
